<template>
  <div id="containerHome">
    ...
    <ImageBanner id="imgBanner">
      <div id="bannerText" style="line-height:1.2em; color: white;" slot="text" class="font-weight-bold fontBanner">
        Sol4U
      ...
      <v-row id="rowField">
        <v-col sm="6" cols="12">
          ...
          <router-link :to="'/channel/create'">
            <v-btn class="ma-2 btnHome" style="width:200px" outlined color="indigo" @click="create()">Create</v-btn>
          </router-link>
          <v-btn class="ma-2 btnHome" style="width:200px" outlined color="red" @click="loginWithGoogle">
